...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        public IActionResult ObterPorId(int id)
        {
            ...
            if(tarefa == null)
            {
                return NotFound();  // Se não encontrar a tarefa, retorna NotFound,
            }
            
            return Ok(tarefa); // Retorna OK com a tarefa encontrada
        }

        [HttpGet("ObterTodos")]
        public IActionResult ObterTodos()
        {
            var tarefas = _context.Tarefas.ToList(); // Busca todas as tarefas no banco utilizando o EF
